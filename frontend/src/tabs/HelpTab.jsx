...
const STEPS = [
  {
    ...
    content: [
      ...
      { heading: 'NSE India Coverage', text: 'QuAInt Signal covers the full Nifty 50 index — India\'s top 50 stocks by market cap. The Scanner tab shows live Nifty 50 movers (gainers, losers, volume). Search any NSE ticker like RELIANCE, TCS, INFY, HDFCBANK, or ICICIBANK.', tip: 'All prices for Indian stocks are shown in ₹ (INR). Options are not available for Indian stocks — only stock scan signals.' },
