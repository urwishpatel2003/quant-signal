...
const STEPS = [
  ...
  },
  {
    ...
    content: [
      ...
      { heading: 'My SIPs Tracker', text: 'Add your active SIPs by name, amount, start date, and frequency. The tracker automatically calculates months elapsed, total amount invested, and shows a portfolio summary. Data is saved locally in your browser.', tip: 'Add all your SIPs including mutual funds by name (e.g. "Parag Parikh Flexi Cap") even if they're not NSE ETFs — the tracker works for any SIP.' },
